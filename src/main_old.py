...
def main():
    ...
    num_cell_segments = 10  # The number of cell segments that partition the knot. Choose between (30,70). Efficiency is lower for larger
    ...
    print(f"started knot growth, gridsize = {grid_size}")
    ...
    lined_grid = lf.draw_line_field(final_grid, grid_size, grid_shape, num_labels)
    
    # vis.plot_solid_voxels(final_grid, num_labels)
    vis.plot_solid_voxels(lined_grid, num_labels)
